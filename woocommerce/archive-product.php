...
get_header('shop'); ?>
    ...
    <header class="woocommerce-products-header">
        <?php if (apply_filters('woocommerce_show_page_title', true)) : ?>
            <section>
                <div class="flex-container archive-header">
                    <div>
                        ...
                        <div class="woocommerce-category-description">
                            ...
                            <?php if (is_shop()) : ?>
                                <?= $shop_description; ?>
                            <?php else: ?>
                                <p><?php echo wpautop($term_object->description); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div>
                        <?php
                            echo wp_get_attachment_image( get_term_meta( get_queried_object_id(), 'thumbnail_id', 1 ), [450, 550] );;
                        ?>
